  ...
  return (
    <Box>
      <Stack direction={{ xs: 'column', md: 'row' }} spacing={2} alignItems={{ md: 'center' }} justifyContent="space-between" sx={{ mb: 2 }}>
        <Typography variant="h4" sx={{ fontWeight: 700 }}>Shipper</Typography>
        <TextField size="small" placeholder="Tìm shipper..." />
      </Stack>
      <Grid container spacing={2} sx={{ mb: 2 }}>
        <Grid item xs={12} md={3}>
          <Paper elevation={0} sx={{ p: 2, borderRadius: 2, border: '1px solid', borderColor: 'divider' }}>
            <Typography variant="subtitle2" color="text.secondary">Tổng Shipper</Typography>
            <Typography variant="h6">156</Typography>
            <Typography variant="caption" color="success.main">+12 shipper mới</Typography>
          </Paper>
        </Grid>
        <Grid item xs={12} md={3}>
          <Paper elevation={0} sx={{ p: 2, borderRadius: 2, border: '1px solid', borderColor: 'divider' }}>
            ...
            <Typography variant="caption" color="success.main">57% tổng số</Typography>
          </Paper>
        </Grid>
        <Grid item xs={12} md={3}>
          <Paper elevation={0} sx={{ p: 2, borderRadius: 2, border: '1px solid', borderColor: 'divider' }}>
        ...
        <Grid item xs={12} md={3}>
          <Paper elevation={0} sx={{ p: 2, borderRadius: 2, border: '1px solid', borderColor: 'divider' }}>
            ...
            <Typography variant="caption" color="success.main">+0.1 điểm</Typography>
          </Paper>
        </Grid>
      </Grid>
          ...
          <TableBody>
            {[1,2,3].map(id => (
              <TableRow key={id}>
                ...
                <TableCell><Chip label={id%2? 'Hoạt động' : 'Tạm dừng'} color={id%2? 'success':'warning'} size="small" /></TableCell>
                <TableCell>{id*80}</TableCell>
